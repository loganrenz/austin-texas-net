...
const droughtLevels = [
  { code: 'D0', label: 'Abnormally Dry', color: '#FFFF00', description: 'Going into drought: short-term dryness. Coming out: lingering effects.' },
  { code: 'D1', label: 'Moderate Drought', color: '#FCD37F', description: 'Some crop damage, water shortages developing. Voluntary water restrictions.' },
  { code: 'D2', label: 'Severe Drought', color: '#FFAA00', description: 'Crop losses likely, water restrictions imposed. Fire risk elevated.' },
  { code: 'D3', label: 'Extreme Drought', color: '#E60000', description: 'Major crop losses. Widespread water shortages. Stage 2+ restrictions.' },
  { code: 'D4', label: 'Exceptional Drought', color: '#730000', description: 'Exceptional and widespread crop losses. Water emergencies. Highest restrictions.' },
]

const resources = [
  { label: 'Austin Water Stage Info', url: 'https://www.austintexas.gov/department/water-conservation', icon: 'i-lucide-droplets' },
  ...
  { label: 'Travis County Burn Ban', url: 'https://www.traviscountytx.gov/fire-marshal/burn-ban', icon: 'i-lucide-flame' },
]
</script>
        ...
        <div class="space-y-3">
          ...
          >
            <div
              ...
              :style="{ backgroundColor: level.color, color: level.code === 'D4' ? 'white' : '#1e293b' }"
            >
              {{ level.code }}
            </div>
      ...
      <section class="mb-10 animate-fade-up-delay-3">
        <div class="rounded-2xl border border-default bg-default p-6 sm:p-8">
          ...
          <div class="text-sm text-muted leading-relaxed space-y-3">
            <p>
              <strong class="text-default">Austin Water</strong> enforces year-round watering schedules
              regardless of drought status. During droughts, the city escalates through
              <strong class="text-default">Stage 1–5 restrictions</strong>:
            </p>
            <ul class="list-disc list-inside space-y-1 pl-2">
              <li><strong class="text-default">Stage 1:</strong> Twice-per-week watering, no watering 10am–7pm.</li>
              <li><strong class="text-default">Stage 2:</strong> Once-per-week watering, hose-end timers required.</li>
              <li><strong class="text-default">Stage 3:</strong> Once every other week. Car washing restricted.</li>
              <li><strong class="text-default">Stage 4:</strong> No outdoor watering except drip irrigation for trees.</li>
              <li><strong class="text-default">Stage 5:</strong> Emergency water management. No outdoor use.</li>
            </ul>
            <p>
              The <strong class="text-default">LCRA</strong> (Lower Colorado River Authority) manages
              the water supply for Austin and the Highland Lakes. Lake Travis levels are the primary
              indicator for drought severity in our region.
            </p>
          </div>
        </div>
      </section>
