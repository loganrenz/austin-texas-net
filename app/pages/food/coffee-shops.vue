...
const config: MapPageConfig = {
  ...
  description:
    'Find the best coffee shops in Austin, TX. Interactive map of the top 10 spots — from local roasters to WiFi-friendly workspaces and cold brew pioneers.',
  introText:
    'Austin\'s coffee scene is as vibrant as its music. From third-wave pour-overs to shady patio hangouts — <strong class="text-default">tap any pin</strong> to find your next favorite shop.',
  parentCategory: 'food',
  parentLabel: '← Food',
  parentPath: '/food/',
