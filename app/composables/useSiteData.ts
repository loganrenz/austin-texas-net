...
export function useSiteData() {
  const categories: Category[] = [
    ...
    /* ── 5. Weather ─────────────────────────────────────────── */
    {
      ...
      subApps: [
        { slug: 'current-conditions', title: 'Current Conditions', description: 'Real-time Austin weather — temperature, humidity, wind, and UV index.', status: 'coming-soon' },
        { slug: 'radar', title: 'Radar', description: 'Live NEXRAD radar for Central Texas — rain, storms, and precipitation.', status: 'coming-soon' },
        { slug: '7-day-forecast', title: '7-Day Forecast', description: 'Extended forecast for Austin — daily highs, lows, and conditions.', status: 'coming-soon' },
        { slug: 'heat-index', title: 'Heat Index', description: 'Current and forecast heat index — feels-like temperature tracking.', status: 'coming-soon' },
        { slug: 'freeze-alerts', title: 'Freeze Alerts', description: 'Winter freeze warnings and pipe protection alerts for Austin.', status: 'coming-soon' },
        { slug: 'drought-status', title: 'Drought Status', description: 'Central Texas drought monitor — watering restrictions and conditions.', status: 'coming-soon' },
      ],
      seo: {
    ...
    /* ── 8. Real Estate ────────────────────────────────────── */
    {
      ...
      subApps: [
        { slug: 'market-trends', title: 'Market Trends', description: 'Austin real estate market trends — sales volume, days on market, and outlook.', status: 'coming-soon' },
        { slug: 'median-home-prices', title: 'Median Home Prices', description: 'Median home prices by Austin neighborhood and zip code.', status: 'coming-soon' },
        { slug: 'property-tax-guide', title: 'Property Tax Guide', description: 'Travis County property tax guide — rates, exemptions, and protest tips.', status: 'coming-soon' },
        { slug: 'new-developments', title: 'New Developments', description: 'New construction and development projects across Austin.', status: 'coming-soon' },
        { slug: 'rent-trends', title: 'Rent Trends', description: 'Austin rent trends by neighborhood — averages, heatmap, and forecasts.', status: 'coming-soon' },
        { slug: 'housing-map', title: 'Housing Map', description: 'Interactive Austin housing map — prices, inventory, and market heat.', status: 'coming-soon' },
      ],
      seo: {
