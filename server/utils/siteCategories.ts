...
export const siteCategories: SitemapCategory[] = [
  ...
  },
  {
    ...
    subApps: [
      ...
      { slug: 'acl-fest', status: 'coming-soon' },
      { slug: 'rodeo-austin', status: 'coming-soon' },
      { slug: 'trail-of-lights', status: 'coming-soon' },
      { slug: 'bat-fest', status: 'coming-soon' },
    ],
  },
  {
    slug: 'outdoors',
    subApps: [
      ...
      { slug: 'hiking-trails', status: 'coming-soon' },
      { slug: 'swimming-holes', status: 'coming-soon' },
      { slug: 'parks-guide', status: 'coming-soon' },
    ],
  },
  {
    slug: 'health',
    subApps: [
      ...
      { slug: 'allergy-forecast', status: 'coming-soon' },
      { slug: 'air-quality', status: 'coming-soon' },
    ],
  },
  {
    slug: 'weather',
