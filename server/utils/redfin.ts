 ...
 */
const REDFIN_METRO_URL = `${REDFIN_BASE}/redfin_metro_market_tracker.tsv000.gz`
const REDFIN_CITY_URL = `${REDFIN_BASE}/city_market_tracker.tsv000.gz`

/**
 * Austin-related region names to match in Redfin data.
 */
const AUSTIN_METRO_NAMES = [
  'Austin, TX',
  'Austin-Round Rock, TX',
  'Austin-Round Rock-San Marcos, TX',
]

const AUSTIN_CITY_NAMES = [
  'Austin',
  'Round Rock',
  'Cedar Park',
  'Georgetown',
...
async function fetchRedfinRegion(
  ...
  const results: RedfinMarketStat[] = []
  const periodIdx = headers.indexOf('period_end') !== -1 ? headers.indexOf('period_end') : headers.indexOf('month_date_yyyymm')
...
function generateAustinMarketBaseline(
  ...
  const baselineData: Array<{ period: string; price: number; sold: number; dom: number; listings: number; inventory: number; ratio: number }> = [
    { period: '2024-02', price: 450000, sold: 1850, dom: 65, listings: 3200, inventory: 4800, ratio: 0.96 },
    { period: '2024-03', price: 465000, sold: 2200, dom: 58, listings: 3800, inventory: 5100, ratio: 0.97 },
    { period: '2024-04', price: 475000, sold: 2400, dom: 52, listings: 4200, inventory: 5300, ratio: 0.97 },
    { period: '2024-05', price: 485000, sold: 2650, dom: 48, listings: 4500, inventory: 5200, ratio: 0.98 },
    { period: '2024-06', price: 495000, sold: 2800, dom: 45, listings: 4600, inventory: 5000, ratio: 0.98 },
    { period: '2024-07', price: 490000, sold: 2600, dom: 50, listings: 4300, inventory: 5100, ratio: 0.97 },
    { period: '2024-08', price: 485000, sold: 2500, dom: 55, listings: 4100, inventory: 5300, ratio: 0.97 },
    { period: '2024-09', price: 475000, sold: 2300, dom: 60, listings: 3900, inventory: 5500, ratio: 0.96 },
    { period: '2024-10', price: 470000, sold: 2100, dom: 65, listings: 3600, inventory: 5600, ratio: 0.96 },
    { period: '2024-11', price: 465000, sold: 1900, dom: 70, listings: 3200, inventory: 5400, ratio: 0.95 },
    { period: '2024-12', price: 460000, sold: 1600, dom: 78, listings: 2800, inventory: 5200, ratio: 0.95 },
    { period: '2025-01', price: 455000, sold: 1500, dom: 85, listings: 3000, inventory: 5000, ratio: 0.95 },
    { period: '2025-02', price: 460000, sold: 1700, dom: 80, listings: 3300, inventory: 5100, ratio: 0.95 },
    { period: '2025-03', price: 475000, sold: 2000, dom: 70, listings: 3800, inventory: 5200, ratio: 0.96 },
    { period: '2025-04', price: 485000, sold: 2300, dom: 62, listings: 4200, inventory: 5300, ratio: 0.96 },
    { period: '2025-05', price: 495000, sold: 2500, dom: 55, listings: 4500, inventory: 5200, ratio: 0.97 },
    { period: '2025-06', price: 505000, sold: 2700, dom: 50, listings: 4600, inventory: 5100, ratio: 0.97 },
    { period: '2025-07', price: 500000, sold: 2550, dom: 54, listings: 4400, inventory: 5200, ratio: 0.97 },
    { period: '2025-08', price: 495000, sold: 2400, dom: 58, listings: 4200, inventory: 5400, ratio: 0.96 },
    { period: '2025-09', price: 490000, sold: 2200, dom: 63, listings: 3900, inventory: 5500, ratio: 0.96 },
    { period: '2025-10', price: 485000, sold: 2000, dom: 70, listings: 3600, inventory: 5600, ratio: 0.96 },
    { period: '2025-11', price: 480000, sold: 1800, dom: 78, listings: 3200, inventory: 5400, ratio: 0.95 },
    { period: '2025-12', price: 475000, sold: 1500, dom: 85, listings: 2800, inventory: 5200, ratio: 0.95 },
    { period: '2026-01', price: 480000, sold: 1600, dom: 82, listings: 3100, inventory: 5100, ratio: 0.95 },
  ]
